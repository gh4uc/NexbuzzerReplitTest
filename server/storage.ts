...
export class MemStorage implements IStorage {
  ...
  async createTransaction(insertTransaction: InsertTransaction): Promise<Transaction> {
    ...
    const transaction: Transaction = { 
      ...
      relatedEntityId: insertTransaction.relatedEntityId || null
    };
  ...
  async createModelProfile(insertProfile: InsertModelProfile): Promise<ModelProfile> {
    ...
    const profile: ModelProfile = { 
      ...
      isVerified: false,
      commissionRate: 0.7,
      isAvailable: insertProfile.isAvailable || false,
      languages: insertProfile.languages || null,
      categories: insertProfile.categories || null,
      voiceRate: insertProfile.voiceRate || null,
      bio: insertProfile.bio || null,
      offerVoiceCalls: insertProfile.offerVoiceCalls || null,
      offerVideoCalls: insertProfile.offerVideoCalls || null,
      videoRate: insertProfile.videoRate || null,
      payoutInfo: insertProfile.payoutInfo || null,
      referrerId: insertProfile.referrerId || null,
      profileImages: insertProfile.profileImages || null
    };
